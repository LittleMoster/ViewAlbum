 ...
 **压缩图片data,返回data
 */
+(NSData*)CompressToDataWithImgData:(NSData*)imageData FileSize:(NSInteger)FileSize
{
    CGFloat compression    = 1.0f;
    CGFloat minCompression = 0.001f;
    NSLog(@"只压不缩-返回Data大小：%ld kb",imageData.length/1000);
 ...
 **压缩图片data,返回image
 */
+(UIImage*)CompressToImageWithImgData:(NSData*)imageData FileSize:(NSInteger)FileSize
{
    CGFloat compression    = 1.0f;
    CGFloat minCompression = 0.001f;
    NSLog(@"只压不缩-返回Data大小：%ld kb",imageData.length/1000);
